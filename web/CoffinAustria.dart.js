...
$.main = function() {
  var t1, newCoffin;
  $.coffinList = $.query('#coffinList');
  $.toDoInput = $.query('#to-do-input');
  $.toDoList = $.query('#to-do-list');
  t1 = $.toDoInput.get$on().get$change();
  $.getInterceptor(t1).add$1(t1, $.addToDoItem);
  newCoffin = $.LIElement_LIElement();
  newCoffin.set$text('test -------------------------');
  t1 = $.coffinList.get$elements();
  $.getInterceptor(t1).add$1(t1, newCoffin);
};

$.addToDoItem = function(e) {
  var newToDo, t1;
  newToDo = $.LIElement_LIElement();
  newToDo.set$text($.toString($.toDoInput.get$value()));
  $.toDoInput.set$value('');
  t1 = $.toDoList.get$elements();
  $.getInterceptor(t1).add$1(t1, newToDo);
};
...
//@ sourceMappingURL=CoffinAustria.dart.js.map